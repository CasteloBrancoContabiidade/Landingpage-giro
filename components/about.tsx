      ...
      <div className="w-[90%] max-w-[1180px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div ref={leftRef} className="reveal">
          ...
          <p className="text-[0.95rem] font-light text-[var(--muted)] leading-relaxed mb-5">
            Desde 2017, a GiroHub transforma ideias complexas em produtos digitais que funcionam de verdade. Somos 38 engenheiros, designers e estrategistas unidos por uma missão: fazer tecnologia que as pessoas usam com prazer.
          </p>
          <p className="text-[0.95rem] font-light text-[var(--muted)] leading-relaxed mb-5">
